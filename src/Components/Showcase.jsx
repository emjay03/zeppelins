        ...
        <div className="flex py-10  w-full overflow-x-auto   scrollbar-hidden ">
          <ul className="flex gap-10 font-Montserrat text-sm md:text-lg font-semibold">
            ...
            <li>
              ...
              >
                <span className={` ${activeFilter==='All'?'text-[#D05270] ':'hover:text-[#D05270]  focus:text-[#D05270] '} `}>
                All
                </span>
              </Link>
            </li>
            <li>
              ...
              >
                                <span className={` ${activeFilter==='All Design'?'text-[#D05270]  ':'text-[#424242]  hover:text-[#D05270]  focus:text-[#D05270] '} `}>All Design</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                <span className={` ${activeFilter==='UX Design'?'text-[#D05270]  ':'text-[#424242]  hover:text-[#D05270]  focus:text-[#D05270] '} `}> UX Design</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                 <span className={` ${activeFilter==='Product Design'?'text-[#D05270]  ':'text-[#424242]  hover:text-[#D05270]  focus:text-[#D05270] '} `}>Product Design</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                 <span className={` ${activeFilter==='Articles'?'text-[#D05270]  ':'text-[#424242]  hover:text-[#D05270]  focus:text-[#D05270] '} `}>Articles</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                 <span className={` ${activeFilter==='Tutorial'?'text-[#D05270]  ':'text-[#424242]  hover:text-[#D05270]  focus:text-[#D05270] '} `}>Tutorial</span>
              </Link>
            </li>
          </ul>
        </div>
